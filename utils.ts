...
export const MESSAGES = [
  ...
  { id: 6, sender: "Theodora Addeafi Gyambrah", text: "To my amazing friend and fellow tech sis… today is all about you and the beautiful soft life you continue to embody.\n" +
        ...
        "\n" +
        "May this new year bring you opportunities that feel aligned, blessings that arrive effortlessly, money that multiplies, rest that renews and joy that overflows. \n" +
        "\n" +
        "Keep glowing. Keep thriving. Keep living softly. You deserve every good thing coming your way. 💗\n" +
        "\n" +
